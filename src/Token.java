...
public class Token implements ZeptonLexerConstants {
    private TokenType type;
    private ZeptonLexer tokenSource;
     ...
     */
    public Token(TokenType type, String image, ZeptonLexer tokenSource) {
        this.type= type;
        this.image= image;
        this.tokenSource= tokenSource;
    }

    public static Token newToken(TokenType type, String image, ZeptonLexer tokenSource) {
    ...
    /**
     * @return the ZeptonLexer object that handles 
     * location info for the tokens. 
     */
    public ZeptonLexer getTokenSource() {
        ZeptonLexer flm= this.tokenSource;
     ...
     */
    public void setTokenSource(ZeptonLexer tokenSource) {
        this.tokenSource= tokenSource;
    }
    ...
    public int getBeginLine() {
        ZeptonLexer flm= getTokenSource();
        return flm== null?0:
    ...
    public Token nextCachedToken() {
        ...
        ZeptonLexer tokenSource= getTokenSource();
    ...
    public Token(TokenType type, ZeptonLexer tokenSource, int beginOffset, int endOffset) {
        this.type= type;
        this.tokenSource= tokenSource;
        this.beginOffset= beginOffset;
        this.endOffset= endOffset;
    ...
    public static Token newToken(TokenType type, ZeptonLexer tokenSource, int beginOffset, int endOffset) {
